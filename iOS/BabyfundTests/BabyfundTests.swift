import XCTest
@testable import Babyfund

final class BabyfundTests: XCTestCase {
    @MainActor
    ...
    func testAddIncreasesCount() {
        ...
        let item = PurchaseItem(category: "Test", item: "Test", amount: 1.0)
        _ = store.add(item)
    ...
    func testFreeLimitBlocksAdd() {
        ...
        for _ in 0..<Store.freeLimit {
            _ = store.add(PurchaseItem(category: "Test", item: "Test", amount: 1.0))
        }
        let result = store.add(PurchaseItem(category: "Test", item: "Test", amount: 1.0))
